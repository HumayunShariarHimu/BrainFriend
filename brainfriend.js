...
const thinks = [
  ...
  "এখন উক্ত Subject এর সহিত পজেটিভ মানসিকতায় শুধুমাত্র পজেটিভ দিকসমূহ যুক্ত করুন",
  "এখন আপনার Subject এর সলিউশন বা সফলতা লাভে কি অথবা কোন কোন Fact গুলো প্রয়োজন হবে সেটা সিলেক্ট করুন",
];
// next and prev
let t = 0;
if (t === 0) {
